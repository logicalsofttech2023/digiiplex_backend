...
// ================= USERS =================
export const Users = authService.table(
  "auth_users",
  {
    id: uuid("id")
...
// ================= PROFILES =================
export const profiles = authService.table(
  "profiles",
  {
    id: uuid("id")
      .default(sql`gen_random_uuid()`)
...
// faqs
export const faqs = authService.table(
  "faqs",
  {
    id: uuid("id")
      .default(sql`gen_random_uuid()`)
...
// about us
export const aboutUs = authService.table(
  "about_us",
  {
    id: uuid("id")
      .default(sql`gen_random_uuid()`)
...
// privacy policy
export const privacyPolicy = authService.table(
  "privacy_policy",
  {
...
export const termsConditions = authService.table(
  "terms_conditions",
  {
    id: uuid("id").default(sql`gen_random_uuid()`).primaryKey(),
