...
// ================= ADMINS =================
export const admins = adminService.table(
  "admins",
  {
...
// ================= CREATORS =================
export const creators = adminService.table(
  "creators",
  {
    id: uuid("id").default(sql`gen_random_uuid()`).primaryKey(),
...
// ================= GENRES =================
export const genres = adminService.table(
  "genres",
  {
    id: uuid("id").default(sql`gen_random_uuid()`).primaryKey(),
...
// ================= LANGUAGES =================
export const languages = adminService.table(
  "languages",
  {
    id: uuid("id").default(sql`gen_random_uuid()`).primaryKey(),
